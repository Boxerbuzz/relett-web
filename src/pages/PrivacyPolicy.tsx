...
const PrivacyPolicy = () => {
  ...
  const tableOfContents = [
    { id: "commitment", title: "Our Privacy Commitment", icon: ShieldIcon },
    { id: "collection", title: "Information We Collect", icon: DatabaseIcon },
    { id: "usage", title: "How We Use Information", icon: EyeIcon },
    { id: "sharing", title: "Information Sharing", icon: ShareNetworkIcon },
    { id: "protection", title: "Data Protection & Security", icon: LockIcon },
    { id: "rights", title: "Your Privacy Rights", icon: UsersIcon },
    { id: "retention", title: "Data Retention", icon: ClockIcon },
    { id: "international", title: "International Transfers", icon: GlobeIcon },
    { id: "cookies", title: "Cookies & Tracking", icon: CookieIcon },
    {
      id: "automated-processing",
      title: "Automated Processing & AI",
      icon: ActivityIcon,
    },
    { id: "blockchain", title: "Blockchain & Public Data", icon: LinkIcon },
    { id: "children", title: "Children's Privacy", icon: WarningIcon },
    { id: "changes", title: "Policy Changes", icon: FileTextIcon },
          ...
          <main className="flex-1 min-w-0 space-y-8">
                ...
                <CardContent className="p-8">
                  ...
                  <div className="prose max-w-none">
                    <p className="text-lg text-gray-700 leading-relaxed mb-6">
                      At Relett, protecting your privacy is fundamental to our
                      mission of democratizing real estate investment. This
                      Privacy Policy explains how we collect, use, protect, and
                      share your information when you use our property
                      tokenization platform and related services.
                    </p>
                    <div className="bg-blue-50 border-l-4 border-blue-500 p-6 rounded-r-lg">
                      ...
                      <ul className="space-y-2 text-blue-800">
                        ...
                        <li>
                          • <strong>Control:</strong> You have control over your
                          personal information
                        </li>
                        <li>
                          • <strong>Security:</strong> We implement
                          industry-leading security measures
                        </li>
                        <li>
                          • <strong>Compliance:</strong> We adhere to all
                          applicable privacy laws and regulations
                        </li>
                        <li>
                          • <strong>Purpose Limitation:</strong> We only use
                          data for legitimate business purposes
                        </li>
                        <li>
                          • <strong>Data Minimization:</strong> We collect only
                          what's necessary for our services
                        </li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div className="space-y-8">
                    <div>
                      <h3 className="text-lg font-semibold mb-4">
                        Data Storage in Our Database
                      </h3>
                      <p className="text-gray-700 mb-4">
                        When you create an account, we automatically populate
                        several database tables with your information:
                      </p>
                      <div className="bg-gray-50 p-4 rounded-lg mb-4">
                        ...
                        <ul className="text-sm text-gray-700 space-y-1">
                          <li>
                            • <strong>Basic Info:</strong> Email, first name,
                            last name, phone number
                          </li>
                          <li>
                            • <strong>Profile Data:</strong> Avatar, bio, user
                            type, verification status
                          </li>
                          <li>
                            • <strong>Account Status:</strong> is_active,
                            is_verified, has_setup flags
                          </li>
                          <li>
                            • <strong>Timestamps:</strong> created_at,
                            updated_at, last login tracking
                          </li>
                        </ul>
                      </div>
                      <div className="bg-gray-50 p-4 rounded-lg mb-4">
                        ...
                        <ul className="text-sm text-gray-700 space-y-1">
                          <li>
                            • <strong>Accounts:</strong> NGN wallet with 0
                            balance and points
                          </li>
                          <li>
                            • <strong>User Roles:</strong> Default 'landowner'
                            role assignment
                          </li>
                          <li>
                            • <strong>Notification Preferences:</strong>{" "}
                            Email/push settings with defaults
                          </li>
                          <li>
                            • <strong>Portfolio Allocations:</strong> Investment
                            targets by property type and location
                          </li>
                        </ul>
                      </div>
                    </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="bg-blue-50 p-4 rounded-lg">
                          ...
                          <ul className="space-y-1 text-sm text-blue-800">
                            ...
                            <li>
                              • Government-issued ID numbers (NIN, BVN, CAC,
                              Passport)
                            </li>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="bg-purple-50 p-4 rounded-lg">
                          ...
                          <ul className="space-y-1 text-sm text-purple-800">
                            ...
                            <li>
                              • Credit and debit card information (tokenized)
                            </li>
                            <li>• Digital wallet addresses and public keys</li>
                            <li>
                              • Payment processor account details (Paystack,
                              Stripe)
                            </li>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="bg-red-50 p-4 rounded-lg">
                          ...
                          <ul className="space-y-1 text-sm text-red-800">
                            ...
                            <li>
                              • Property specifications and condition reports
                            </li>
                            <li>
                              • AI-generated valuations and market analysis
                            </li>
                            <li>• Rental history and income records</li>
                            <li>
                              • Property views, likes, and favorites tracking
                            </li>
                ...
                <CardContent className="p-8">
                  ...
                  <div className="space-y-6">
                    <p className="text-gray-700 leading-relaxed">
                      ...
                      enhance your experience and provide intelligent services.
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="bg-blue-50 p-6 rounded-lg">
                        ...
                        <ul className="text-sm text-blue-800 space-y-2">
                          <li>
                            • <strong>Model Used:</strong> GPT-4 with custom
                            real estate training
                          </li>
                          <li>
                            • <strong>Data Processed:</strong> Property details,
                            location, market comparables
                          </li>
                          <li>
                            • <strong>Purpose:</strong> Generate accurate
                            property valuations
                          </li>
                          <li>
                            • <strong>Human Oversight:</strong> All AI
                            valuations reviewed by certified valuers
                          </li>
                          <li>
                            • <strong>Your Rights:</strong> Request manual
                            review of any AI valuation
                          </li>
                        </ul>
                      </div>
                      ...
                      <div className="bg-green-50 p-6 rounded-lg">
                        ...
                        <ul className="text-sm text-green-800 space-y-2">
                          <li>
                            • <strong>Risk Scoring:</strong> Automated analysis
                            of transaction patterns
                          </li>
                          <li>
                            • <strong>Document Verification:</strong> AI-powered
                            document authenticity checks
                          </li>
                          <li>
                            • <strong>Behavioral Analysis:</strong> Detection of
                            unusual account activity
                          </li>
                          <li>
                            • <strong>AML Screening:</strong> Automated
                            sanctions and watchlist checks
                          </li>
                          <li>
                            • <strong>Appeal Process:</strong> Immediate human
                            review upon request
                          </li>
                        </ul>
                      </div>
                      ...
                      <div className="bg-purple-50 p-6 rounded-lg">
                        ...
                        <ul className="text-sm text-purple-800 space-y-2">
                          <li>
                            • <strong>Portfolio Analysis:</strong> AI
                            optimization of investment allocations
                          </li>
                          <li>
                            • <strong>Market Matching:</strong> Properties
                            matched to your preferences
                          </li>
                          <li>
                            • <strong>Risk Assessment:</strong> Automated
                            investment risk calculations
                          </li>
                          <li>
                            • <strong>Performance Prediction:</strong> AI-based
                            ROI forecasting
                          </li>
                          <li>
                            • <strong>Transparency:</strong> All recommendation
                      ...
                      <div className="bg-orange-50 p-6 rounded-lg">
                        ...
                        <ul className="text-sm text-orange-800 space-y-2">
                          <li>
                            • <strong>Chat Assistance:</strong> AI-powered
                            customer support responses
                          </li>
                          <li>
                            • <strong>Intent Recognition:</strong> Understanding
                            and routing user queries
                          </li>
                          <li>
                            • <strong>Multilingual Support:</strong> Automatic
                            language detection and translation
                          </li>
                          <li>
                            • <strong>Learning Patterns:</strong> Improving
                            responses based on interactions
                          </li>
                          <li>
                            • <strong>Human Escalation:</strong> Seamless
                    ...
                    <div className="bg-yellow-50 border-l-4 border-yellow-500 p-6 rounded-r-lg">
                      ...
                      <ul className="text-yellow-800 space-y-2">
                        <li>
                          • Right to human review of any automated decision
                          affecting you
                        </li>
                        <li>
                          • Right to explanation of AI decision-making logic
                        </li>
                        <li>
                          • Right to contest automated decisions and request
                          manual processing
                        </li>
                        <li>
                          • Right to opt-out of certain AI features (may limit
                          service functionality)
                        </li>
                        <li>
                          • Right to data correction if AI decisions are based
            ...
            <section id="blockchain">
              <Card>
                <CardContent className="p-8">
                  <div className="flex items-center gap-3 mb-6">
                    <HardDrivesIcon className="h-6 w-6 text-indigo-600" />
                    <h2 className="text-2xl font-bold">
                      Blockchain & Public Data
                    </h2>
                  </div>
                  <div className="space-y-6">
                    <p className="text-gray-700 leading-relaxed">
                      Our platform uses blockchain technology for property
                      tokenization and transaction transparency. Some data
                      becomes permanently public on the blockchain.
                    </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="bg-blue-50 p-6 rounded-lg">
                        ...
                        <ul className="text-sm text-blue-800 space-y-2">
                          <li>
                            • <strong>Token Transactions:</strong> All token
                            transfers are publicly visible
                          </li>
                          <li>
                            • <strong>Wallet Addresses:</strong> Pseudonymous
                            identifiers for transactions
                          </li>
                          <li>
                            • <strong>Property Tokens:</strong> Token supply and
                            basic property metadata
                          </li>
                          <li>
                            • <strong>Smart Contracts:</strong> Contract code
                            and transaction history
                          </li>
                          <li>
                            • <strong>Revenue Distributions:</strong> Dividend
                            payment records
                          </li>
                        </ul>
                        <div className="mt-4 p-3 bg-blue-100 rounded">
                          <p className="text-xs text-blue-900">
                            <strong>Note:</strong> Blockchain data is
                            pseudonymous - wallet addresses are not directly
                            linked to personal identities unless you choose to
                      ...
                      <div className="bg-green-50 p-6 rounded-lg">
                        ...
                        <ul className="text-sm text-green-800 space-y-2">
                          <li>
                            • <strong>Personal Identity:</strong> Never stored
                            on blockchain
                          </li>
                          <li>
                            • <strong>Property Details:</strong> Sensitive
                            information kept off-chain
                          </li>
                          <li>
                            • <strong>Financial Data:</strong> Account balances
                            and personal finances private
                          </li>
                          <li>
                            • <strong>Legal Documents:</strong> Stored securely
                            in encrypted databases
                          </li>
                          <li>
                            • <strong>Communication:</strong> Messages and chat
                            data remain private
                          </li>
                        </ul>
                        <div className="mt-4 p-3 bg-green-100 rounded">
                          <p className="text-xs text-green-900">
                            <strong>Security:</strong> We use advanced
                            cryptographic techniques to protect your privacy
                            while enabling blockchain transparency.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="bg-gray-50 p-4 rounded-lg">
                        ...
                        <ul className="text-sm text-gray-700 space-y-1">
                          <li>
                            • <strong>Network:</strong> Hedera Hashgraph
                            (enterprise-grade DLT)
                          </li>
                          <li>
                            • <strong>Token Standard:</strong> Hedera Token
                            Service (HTS)
                          </li>
                          <li>
                            • <strong>Transaction Fees:</strong> Minimal network
                            fees (typically $0.0001)
                          </li>
                          <li>
                            • <strong>Finality:</strong> Transactions confirmed
                            in 3-5 seconds
                          </li>
                          <li>
                          ...
                          <li>
                            • <strong>Compliance:</strong> Built-in regulatory
                            compliance features
                          </li>
                        </ul>
                      </div>
            ...
            <div className="text-center text-sm text-gray-600 space-y-2">
              <p>
                ...
                contact us at privacy@terravault.com
              </p>
              <p>
                This policy complies with applicable data protection laws
                including NDPR, GDPR, and CCPA.
              </p>
              <p>
                We are committed to transparency and will notify you of any
