...
import { ArrowLeftIcon, ChartBarIcon, TrendUpIcon, CurrencyDollarIcon } from '@phosphor-icons/react';
    ...
    <div className="space-y-6">
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              ...
              <CurrencyDollarIcon size={24} className="text-blue-600" />
            </div>
          </CardContent>
        </Card>
      ...
      <Card>
        ...
        <CardContent className="p-8 text-center">
          <ChartBarIcon size={48} className="mx-auto text-gray-400 mb-4" />
        ...
        <CardContent>
          <div className="space-y-3">
            <div className="flex justify-between items-center p-3 bg-gray-50 rounded">
              ...
              <span className="text-sm text-green-600"><CurrencyDollarIcon className="h-5 w-5 text-green-600" />+$1,250</span>
            </div>
            <div className="flex justify-between items-center p-3 bg-gray-50 rounded">
            ...
            <div className="flex justify-between items-center p-3 bg-gray-50 rounded">
              ...
              <span className="text-sm text-blue-600"><TrendUpIcon className="h-5 w-5 text-blue-600" />+5.2%</span>
            </div>
          </div>
        </CardContent>
      </Card>
