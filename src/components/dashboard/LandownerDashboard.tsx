  ...
  const stats = [
    {
      ...
      trend:
        properties.length > 0 ? { value: 50, isPositive: true } : undefined,
    },
    {
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-4 mt-2 text-sm text-gray-600">
                      ...
                      {property.is_tokenized && property.tokenized_property && (
                        <span>
                          Tokens: {property.tokenized_property.total_supply}
                        </span>
                      )}
                    </div>
                  </div>
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                ...
                <span className="text-lg font-bold">
                  ...
                  {tokenizedProperties
                    .reduce(
                      (sum, prop) => sum + prop.total_dividends_received,
                      0
                    )
                    .toLocaleString()}
                </span>
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <div className="text-sm text-gray-600">
                Strong performance across {tokenizedProperties.length} tokenized
                investments
              </div>
            </div>
          </CardContent>
