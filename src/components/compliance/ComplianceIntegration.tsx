...
export function ComplianceIntegration() {
  ...
  const fetchComplianceData = async () => {
    ...
    try {
      ...
      const formattedChecks: ComplianceCheck[] = (amlData || []).map(
        (check) => ({
          id: check.id,
          user_id: check.user_id,
          check_type: check.check_type,
          status: check.status as
            | "pending"
            | "passed"
            | "failed"
            | "requires_review",
  ...
  const getStatusIcon = (status: string) => {
    switch (status) {
      ...
      case "failed":
      case "rejected":
        return <WarningIcon className="h-4 w-4 text-red-500" />;
      case "pending":
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Compliant users</p>
          </CardContent>
        </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Run checks and validate transactions
          </CardDescription>
        </CardHeader>
        ...
        <TabsContent value="checks" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Review user compliance status and risk assessments
              </CardDescription>
            </CardHeader>
            <CardContent>
                        ...
                        <div className="space-y-1">
                          <div className="flex items-center space-x-2">
                            ...
                            {check.risk_level && (
                              <Badge
                                variant="outline"
                                className={getRiskLevelColor(check.risk_level)}
                              >
        ...
        <TabsContent value="audit" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Track all user activities and flagged events
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="kyc" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Identity verification status and scores
              </CardDescription>
            </CardHeader>
            <CardContent>
