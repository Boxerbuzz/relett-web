...
export function VerificationTaskList({
      ...
      const { data, error } = await supabase
        ...
        .select(
          ...
          *,
          ...
          users!inner(first_name, last_name, email, avatar)
        `
        )
  ...
  const getStatusIcon = (status: string) => {
    switch (status) {
      ...
      default:
        return <WarningDiamondIcon className="w-4 h-4" />;
    }
  };
        ...
        {filteredTasks.length === 0 ? (
          <Card>
            <CardContent className="p-8 text-center">
              <WarningDiamondIcon className="w-12 h-12 text-gray-400 mx-auto mb-4" />
                  ...
                  <div className="flex-1">
                    ...
                    <CardDescription className="mt-1">
                      <div className="flex items-center gap-4 text-sm">
                        ...
                        <span>{capitalize(task.properties.type)}</span>
