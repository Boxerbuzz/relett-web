...
const currencies = [
  ...
  { code: "EUR", name: "Euro", symbol: "€", icon: CurrencyEurIcon },
        ...
        <div className="space-y-6 px-4 md:px-0">
          <Card>
            <CardContent className="p-4">
              <p className="text-sm text-gray-600 mb-4">
                Select your preferred currency for displaying prices and
                calculations.
              </p>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
            <p className="text-sm text-blue-800">
              <strong>Note:</strong> Currency conversion rates are updated in
              real-time. Your investments will still be processed in the
              original currency.
            </p>
          </div>
        </div>
