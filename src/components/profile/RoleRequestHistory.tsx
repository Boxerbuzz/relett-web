...
export function RoleRequestHistory({ onSubmitNewRequest }: RoleRequestHistoryProps) {
                ...
                {request.reason && (
                  <div className="bg-gray-50 rounded-lg p-3">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="text-sm font-medium text-gray-700">Request Reason</span>
                    </div>
                ...
                {request.admin_notes && request.status === 'rejected' && (
                  <div className="bg-red-50 border border-red-200 rounded-lg p-3">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="text-sm font-medium text-red-700">Admin Notes</span>
                    </div>
