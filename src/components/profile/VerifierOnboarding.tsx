  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: 'Your verifier application has been submitted for review. You will be notified once it has been processed.',
      });
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div className="text-center mb-8">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Become a Verifier</h1>
        <p className="text-gray-600">
          Join our network of professional verifiers and help ensure property authenticity
        </p>
      </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <Select value={formData.verifier_type} onValueChange={(value) => setFormData({...formData, verifier_type: value})}>
                <SelectTrigger>
            ...
            <Button 
              onClick={() => setStep(2)}
              disabled={!formData.verifier_type || !formData.license_number || !formData.issuing_authority || !formData.license_name}
              className="w-full"
            >
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <p className="text-sm text-gray-600 mb-2">
                Please upload your professional license, certifications, and any other relevant documents
              </p>
              <Input
                id="documents"
                type="file"
        ...
        <Card>
          <CardContent className="p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
              Your verifier application has been submitted successfully. Our team will review your credentials and notify you once the verification process is complete.
            </p>
