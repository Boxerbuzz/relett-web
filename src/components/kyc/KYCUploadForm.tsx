    ...
    <div className="space-y-6">
              ...
              {documents.map((doc) => (
                <div key={doc.id} className="flex items-center justify-between p-3 border rounded-lg">
                  ...
                  <div className="flex items-center gap-2">
                    <span className={`px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(doc.verification_status)}`}>
      ...
      <Card className="border-blue-200 bg-blue-50">
        <CardContent className="p-4">
          <h3 className="font-semibold text-blue-800 mb-2">KYC Verification Process</h3>
          <ul className="text-sm text-blue-700 space-y-1">
            <li>• Upload clear, readable copies of your identification documents</li>
            <li>• Our verification team will review your documents within 24-48 hours</li>
            <li>• You'll receive a notification once your documents are verified</li>
